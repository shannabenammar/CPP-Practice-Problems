...
public class RationalTest
{
    public static void main(String[] args) throws Exception
    {
        ...
        // Check for normalization of rationals
        normalizationCheck(r, 1, 2);
        ...
        r = new Rational(3);
        if(r.getNumerator() != 3 || r.getDenominator() != 1) getError(r, 3, 1);

        // Check default constructor
        r = new Rational();
        if(r.getNumerator() != 0 || r.getDenominator() != 1) getError(r, 0, 1);

        // Check compareTo method
        Rational r1 = new Rational(1, 3), r2 = new Rational(1, 2);
        ...
        catch(RationalException ignored) { }
    ...
    static String myToString(Rational r)
    {
        return r.getNumerator() + (r.getDenominator() != 1 ? "/" + r.getDenominator() : "");
    }
